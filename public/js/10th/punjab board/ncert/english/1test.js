...
//     questionElement.textContent = `${questions[index].num}. ${questionText}`;
...
//     let navHtml = ""; // Build HTML string to avoid repeated DOM manipulation
...
//     navElement.innerHTML = navHtml; // Update DOM only once
// }
